...
export class InvoiceListComponent implements OnInit, AfterViewInit {
  ...
  getRowId(event: any): void {
    ...
    if (event.event.target.closest(".activityLogs-icon")) {
      console.log(event.data.invoiceId,"event.data.invoiceId",event.data);
      
      const invoiceOrderRowId = event.data.invoiceId;
      this.tableRowId = invoiceOrderRowId;
      this.isAuditlogOpen = true;
    }
  }
...
//       <span class="icon-container text-primary edit-icon" data-id="${params.data.id}" title="Edit" style="display: block; width: 20px; height: 20px;">
//         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
//           <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487..."/>
//         </svg>
//       </span>
//       <span class="icon-container text-danger delete-icon" data-id="${params.data.id}" title="Delete" style="display: block; width: 20px; height: 20px;">
//         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
//           <path stroke-linecap="round" stroke-linejoin="round" d="m14.74 9..."/>
//         </svg>
//       </span>
//       <span class="icon-container text-info activityLogs-icon" data-id="${params.data.id}" title="Activity Logs" style="display: block; width: 20px; height: 20px;">
//         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  renderActionIcons(params: any): string {
    return `
        <div class="action-icons d-flex align-items-center justify-content-around">
          ...
          <span class="icon-container text-info activityLogs-icon" data-id="${params.data.id}" title="Audit Logs" style="display: block; width: 20px; height: 20px;">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
